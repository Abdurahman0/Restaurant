	...
	return (
		<div className='bg-white'>
			<div className='bg-[url("/restoranbg.jpg")] bg-cover bg-center bg-[#2E0F10]/60 bg-blend-multiply mb-5 block md:hidden'>
				<div className='max-w-7xl mx-auto px-4 sm:px-10 lg:px-30'>
					<div className='flex flex-col gap-6.25'>
						<div className='flex flex-col items-center justify-center text-[#FFB200]'>
							<h3 className='text-[#DD1C1C] font-bold text-xl'>
								{t('forSale')}
							</h3>
							<p className='text-lg py-2 font-medium'>{t('forSaleDesc1')}</p>
							<p className='max-w-64 font-semibold text-lg'>
								{t('forSaleDesc2_1')}{' '}
								<span className='text-[#DD1C1C]'>10%</span>{' '}
								{t('forSaleDesc2_2')}
							</p>
						</div>
			...
			<div className='max-w-full mx-auto lg:px-30 md:block hidden pt-10'>
